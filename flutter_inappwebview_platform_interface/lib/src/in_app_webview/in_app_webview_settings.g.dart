...
class InAppWebViewSettings {
  ...
  static InAppWebViewSettings? fromMap(Map<String, dynamic>? map) {
    ...
    final instance = InAppWebViewSettings(
      ...
      asyncAjaxRequestRedirectToHost: map['asyncAjaxRequestRedirectToHost'],
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      "asyncAjaxRequestRedirectToHost": asyncAjaxRequestRedirectToHost,
